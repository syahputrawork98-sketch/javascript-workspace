...
export const metadata = {
  title: "JavaScript Focuspace",
  description: "Reader layer untuk JavaScript Learning Hub",
};
          ...
          <header className="border-b border-slate-200/80 bg-[#fffdf8]/90 backdrop-blur">
            <div className="mx-auto flex h-14 w-full max-w-7xl items-center justify-between px-4 md:px-6">
              <Link href="/" className="flex flex-col leading-none">
                <span className="text-sm font-medium tracking-tight text-slate-900">JavaScript Focuspace</span>
                <span className="text-[11px] uppercase tracking-[0.18em] text-slate-500">Reader for Learning Hub</span>
              </Link>
